...
#' @export
filterOneCount <- function(bamfilein,bamfileout,chromosomes,win,step,threshold,pvalueThreshold,minR){
  #load libraries
  ...
  for (chr in chromosomes){
    ...
    windows <- computeWinCount(positionPos$start,positionPos$end,positionNeg$start,positionNeg$end,len,win,step,logitThreshold,minR)
