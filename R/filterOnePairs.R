...
#' @export
#' 
filterOnePairs <- function(bamfilein,bamfileout,statfile,chromosomes,mustKeepRanges,getWin = FALSE,xlim,readLength,win,step,pvalueThreshold=0.05,minCov=0,maxCov=0,threshold=0.7,errorRate=0.01,pair="free"){
  startTime <- proc.time()
