...
RcppExport SEXP rnaCleanR_computeWinInfo(SEXP covPosLenSEXP, SEXP covPosValSEXP, SEXP covNegLenSEXP, SEXP covNegValSEXP, SEXP readLengthSEXP, SEXP endSEXP, SEXP winSEXP, SEXP stepSEXP, SEXP minCovSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(computeWinInfo(covPosLen, covPosVal, covNegLen, covNegVal, readLength, end, win, step, minCov));
