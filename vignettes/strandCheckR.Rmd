...
The returned DataFrame has 10 columns that corresponds to the read type (R1 or
...
The regions with highest read counts, for example, can be obtained as follows.
...
An example to get the highest coverage windows that overlap with transcripts:
